...
type TripStaus int32

const (
	TripStaus_TS_NOT_SPECIFIED TripStaus = 0
	TripStaus_NOT_STARTED      TripStaus = 1
	TripStaus_IN_PROGRESS      TripStaus = 2
	TripStaus_FINISHED         TripStaus = 3
	TripStaus_PAID             TripStaus = 4
)

// Enum value maps for TripStaus.
var (
	TripStaus_name = map[int32]string{
		0: "TS_NOT_SPECIFIED",
		1: "NOT_STARTED",
		2: "IN_PROGRESS",
		3: "FINISHED",
	...
	TripStaus_value = map[string]int32{
		"TS_NOT_SPECIFIED": 0,
		"NOT_STARTED":      1,
		"IN_PROGRESS":      2,
		"FINISHED":         3,
...
func (x TripStaus) Enum() *TripStaus {
	p := new(TripStaus)
	*p = x
	return p
}

func (x TripStaus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TripStaus) Descriptor() protoreflect.EnumDescriptor {
	return file_trip_proto_enumTypes[0].Descriptor()
}

func (TripStaus) Type() protoreflect.EnumType {
	return &file_trip_proto_enumTypes[0]
}

func (x TripStaus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TripStaus.Descriptor instead.
func (TripStaus) EnumDescriptor() ([]byte, []int) {
...
type Trip struct {
	...
	Status        TripStaus   `protobuf:"varint,8,opt,name=status,proto3,enum=coolcar.TripStaus" json:"status,omitempty"`
...
func (x *Trip) GetStatus() TripStaus {
	if x != nil {
		return x.Status
	}
	return TripStaus_TS_NOT_SPECIFIED
}
...
var file_trip_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0xae, 0x02, 0x0a, 0x04,
	...
	0x32, 0x12, 0x2e, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x54, 0x72, 0x69, 0x70, 0x53,
	0x74, 0x61, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x10, 0x0a, 0x03,
	0x65, 0x6e, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x12, 0x21,
	...
	0x63, 0x12, 0x19, 0x0a, 0x08, 0x66, 0x65, 0x65, 0x5f, 0x63, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x07, 0x66, 0x65, 0x65, 0x43, 0x65, 0x6e, 0x74, 0x22, 0x20, 0x0a, 0x0e,
	...
	0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x74, 0x72, 0x69, 0x70, 0x2a, 0x5b, 0x0a, 0x09, 0x54, 0x72, 0x69, 0x70, 0x53, 0x74, 0x61, 0x75,
	...
	0x12, 0x3c, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x12, 0x17, 0x2e, 0x63, 0x6f,
	0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x47,
	0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1c,
	0x5a, 0x1a, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67,
...
var file_trip_proto_goTypes = []interface{}{
	(TripStaus)(0),          // 0: coolcar.TripStaus
...
var file_trip_proto_depIdxs = []int32{
	...
	1, // 2: coolcar.Trip.path_locaitons:type_name -> coolcar.Location
	0, // 3: coolcar.Trip.status:type_name -> coolcar.TripStaus
